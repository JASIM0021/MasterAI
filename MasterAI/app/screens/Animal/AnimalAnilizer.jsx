...
import { useAnimalAnalizeMutation } from '../../features/api/upload/uploadPhoto';
...
const AnimalAnalizer = () => {
  ...
  console.log(data?.response?.responsea, 'data');
  ...
  return (
    ...
    >
      ...
      <Header isBack={true} title="Animal Name Finder" />
